...
<body>
    <div class="container">
        <div class="sidebar">
            <!-- <h2>Name</h2> -->
            <!-- <a href="" class="profile-button">患者資料</a> -->
            <?php
                if(isset($使用者姓名)) {
        ...
        <div class="content">
            <h1>HEALPER</h1>
            <div class="navbar">
                <div class="navi-thispage"><a href="m-current.html">目前測量數據</a></div>
                <div class="navi"><a href="m-today.html">當日平均數據</a></div>
                <div class="navi"><a href="m-history.html">歷史數據</a></div>
            </div>
            <div class="data-grid">
                <div class="grid-up">
                    <h3>心律</h3>
