<?php
    ...
    if(isset($_GET['search_keyword']) && !empty($_GET['search_keyword'])) {
        ...
        $sql="SELECT 使用者姓名 FROM 使用者 WHERE 健保卡號 = '$search_keyword' OR 病例號='$search_keyword'";
    ...
    if(isset($_SESSION['健保卡號'])) {
        $健保卡號 = $_SESSION['健保卡號'];

        $sql="SELECT 使用者姓名 FROM 使用者 WHERE 健保卡號 = '$健保卡號'";
        $result = $conn->query($sql);
...
<body>
    <div class="container">
        <div class="sidebar">
            <!-- <h2>Name</h2> -->
            <!-- <a href="http://127.0.0.1:8080/Healper/information.php" class="profile-button">個人資料</a> -->
            <?php
                if(isset($使用者姓名)) {
                    echo "<h2>使用者姓名：" . $使用者姓名 . "</h2>";
                    echo "<a href='information.php?健保卡號=$健保卡號' class='profile-button'>個人資料</a>";
                }
            ?>
            <div class="photo">
                <h3>photo</h3>
        ...
        <div class="content">
            ...
            <div class="navbar">
                ...
                <div class="navi"><a href="today.html">當日平均數據</a></div>
                <div class="navi"><a href="history.html">歷史數據</a></div>
            </div>
            <div class="data-grid">
                <div class="grid-up">
                    <h3>心律</h3>
